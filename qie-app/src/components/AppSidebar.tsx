    ...
    <aside className="w-64 h-screen bg-surface-1/55 backdrop-blur-2xl border-r border-white/[0.08] flex flex-col select-none">
      ...
      <div className="flex-1 overflow-y-auto px-3 py-2 space-y-4 no-scrollbar">
        ...
        <SidebarSection label="Operations">
          <SidebarItem icon={Shield} label="Advanced" path="/app/advanced" isActive={isAt('/app/advanced') || isAt('/app/escrow') || isAt('/app/buyer-escrow') || isAt('/app/subscription') || isAt('/app/installment') || isAt('/app/batch') || isAt('/app/multipay')} badge="V1.5" badgeColor="bg-primary/15 text-primary" onNavigate={nav} />
